  ...
  <div class="flex h-full">
    ...
    <template v-if="hasDisplayableOriginalFile">
      ...
      <div class="w-1/2 border-r overflow-auto p-4 flex flex-col">
        <h4 class="font-medium text-slate-700 dark:text-slate-300 mb-2">Original File</h4>
        <!-- PDF Viewer -->
        <iframe
        ...
        <div
          v-else
          class="text-slate-400 dark:text-slate-500 flex items-center justify-center flex-1"
        >
