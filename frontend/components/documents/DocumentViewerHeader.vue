<template>
  <div class="flex items-center justify-between p-4 border-b bg-slate-50 rounded-t-lg">
    ...
    <div class="flex items-center space-x-2">
      ...
      <span
        ...
        class="inline-flex items-center px-3 py-1.5 border border-slate-200 text-sm font-medium rounded-md text-slate-500 bg-slate-50"
