<template>
  ...
  >
    ...
    <div class="flex items-center gap-3">
      ...
      <div class="ml-auto text-sm text-gray-500 dark:text-gray-400">{{ totalCount }} documents</div>
    </div>
    ...
    <div class="flex items-center gap-2 mt-3 pt-3 border-t border-gray-200 dark:border-slate-600">
      <label class="flex items-center gap-2 cursor-pointer">
        ...
        <span class="text-sm text-gray-700 dark:text-gray-300">
          ...
          <span v-if="includeArchived" class="text-xs text-gray-500 ml-1">
