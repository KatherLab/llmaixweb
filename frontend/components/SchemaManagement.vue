<template>
  <div class="p-6">
          ...
          <div class="p-6">
            <div class="flex justify-between items-start mb-4">
              <div>
                ...
                <p v-if="prompt.description" class="mt-1 text-sm text-gray-500">
                  {{ prompt.description }}
                </p>
    ...
    <Teleport to="body">
      ...
      >
        <div
          class="bg-white rounded-lg w-full h-[90vh] max-w-[1600px] my-8 flex flex-col mx-auto"
          @click.stop
        >
          ...
          >
            <div class="flex-1 flex flex-col min-h-0">
              ...
              <div class="px-6 pt-4 pb-2 flex-shrink-0">
                <label for="schema-name" class="block text-sm font-medium text-gray-700"
                  >Schema Name</label
                >
                <input
                  id="schema-name"
              ...
              <p v-if="schemaError" class="px-6 py-2 text-sm text-red-600 flex-shrink-0">
                {{ schemaError }}
              </p>
            </div>
    ...
    <Teleport to="body">
      ...
      >
        <div
          class="bg-white rounded-xl w-full max-w-4xl my-8 mx-auto max-h-[90vh] flex flex-col shadow-2xl"
          @click.stop
        >
          <div class="p-6 border-b flex items-center justify-between flex-shrink-0">
            <h3 class="text-lg font-medium text-gray-900">
            ...
            <button class="text-gray-400 hover:text-gray-500" @click="cancelPromptModal">
              <svg
                class="h-6 w-6"
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
          ...
          >
            <div class="flex-1 overflow-y-auto p-6 space-y-8">
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <label for="prompt-name" class="block text-sm font-semibold text-gray-800 mb-1"
                  ...
                  <input
                    ...
                    required
                  />
                  <p v-if="!promptForm.name && isSubmitting" class="mt-1 text-xs text-red-600">
              ...
              <div class="flex items-start bg-blue-50 border border-blue-200 rounded-lg p-4">
                ...
                <div class="ml-3">
                  ...
                  <p class="text-sm text-blue-800">
                    Use
                    <code class="px-1.5 py-0.5 bg-blue-100 text-blue-800 rounded font-mono text-xs"
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div>
                  <div class="mb-2 flex items-center gap-2">
                    <label
                      for="system-prompt"
                      class="block text-sm font-medium text-gray-800 flex-1"
                      >System Prompt</label
                    >
                    <span
                      v-if="promptForm.system_prompt?.includes('{document_content}')"
                      class="inline-flex items-center text-xs bg-green-100 text-green-700 px-2 py-0.5 rounded-full"
                    >
                      <svg
                        class="h-3 w-3 mr-1"
                        fill="none"
                ...
                <div>
                  <div class="mb-2 flex items-center gap-2">
                    <label for="user-prompt" class="block text-sm font-medium text-gray-800 flex-1"
                      >User Prompt</label
                    >
                    <span
            ...
            <!-- Modal Footer -->
            <div
              class="px-6 py-4 bg-gray-50 border-t flex flex-col md:flex-row md:items-center md:justify-between space-y-3 md:space-y-0 md:space-x-3 flex-shrink-0"
            >
              <button
                type="button"
    ...
    <Teleport to="body">
      ...
      >
        <div
          class="bg-white rounded-xl max-w-3xl w-full p-6 max-h-[90vh] overflow-y-auto"
          @click.stop
        >
          <div class="flex justify-between items-start mb-6">
            <div>
              <h3 class="text-lg font-medium text-gray-900">{{ currentPrompt?.name }}</h3>
              <p v-if="currentPrompt?.description" class="mt-1 text-sm text-gray-500">
                {{ currentPrompt.description }}
              </p>
            </div>
            <button class="text-gray-400 hover:text-gray-500" @click="showViewPromptModal = false">
              <svg
                class="h-6 w-6"
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
      ...
      >
        <div class="bg-white rounded-lg max-w-2xl w-full p-6" @click.stop>
          <div class="flex justify-between items-center mb-4">
            ...
            <button class="text-gray-400 hover:text-gray-500" @click="showViewModal = false">
              <svg
                class="h-6 w-6"
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
