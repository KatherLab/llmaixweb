<template>
  <div class="p-6">
    ...
    <Teleport to="body">
      ...
      >
        <div
          class="bg-white dark:bg-slate-900 rounded-lg w-full h-[90vh] max-w-[1600px] my-8 flex flex-col mx-auto"
          @click.stop
        >
          <div
          ...
          >
            ...
            >
              <button
                type="button"
                class="inline-flex justify-center px-4 py-2 border border-gray-300 dark:border-slate-600 shadow-sm text-sm font-medium rounded-md text-gray-700 dark:text-slate-300 bg-white dark:bg-slate-700 hover:bg-gray-50 dark:hover:bg-slate-600"
                @click="cancelSchemaModal"
              >
                Cancel
              </button>
    ...
    <Teleport to="body">
      ...
      >
        <div
          class="bg-white dark:bg-slate-900 rounded-xl w-full max-w-4xl my-8 mx-auto max-h-[90vh] flex flex-col shadow-2xl"
          @click.stop
        >
          <div
            class="p-6 border-b dark:border-slate-700 flex items-center justify-between flex-shrink-0"
          ...
          <form
            class="flex flex-col flex-1 min-h-0"
            @submit.prevent="showEditPromptModal ? updatePrompt() : createPrompt()"
          >
            <div class="flex-1 overflow-y-auto p-6 space-y-8">
                ...
                <div>
                  <div class="mb-2 flex items-center gap-2">
                    ...
                    <span
                      ...
                      class="inline-flex items-center text-xs bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-300 px-2 py-0.5 rounded-full"
                    >
                      <svg
                        class="h-3 w-3 mr-1"
                        fill="none"
              ...
              >
                <div class="flex">
                  ...
                  <div class="ml-3">
                    <p class="text-sm text-red-800 dark:text-red-300">{{ promptError }}</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            >
              ...
              <div class="flex space-x-3">
                <button
                  type="button"
                  class="inline-flex justify-center px-4 py-2 border border-gray-300 dark:border-slate-600 shadow-sm text-sm font-medium rounded-lg text-gray-700 dark:text-slate-300 bg-white dark:bg-slate-700 hover:bg-gray-50 dark:hover:bg-slate-600 transition"
                  @click="cancelPromptModal"
                >
                  Cancel
                </button>
    ...
    <Teleport to="body">
      ...
      >
        <div
          class="bg-white dark:bg-slate-900 rounded-xl max-w-3xl w-full p-6 max-h-[90vh] overflow-y-auto"
          @click.stop
        >
          <div class="flex justify-between items-start mb-6">
            <div>
              ...
              <p
                v-if="currentPrompt?.description"
          ...
          <div class="space-y-4">
            <div
              v-if="currentPrompt?.system_prompt"
            ...
            <div
              v-if="currentPrompt?.user_prompt"
          ...
          <div class="mt-6 flex justify-end">
            <button
              class="inline-flex justify-center px-4 py-2 border border-gray-300 dark:border-slate-600 shadow-sm text-sm font-medium rounded-lg text-gray-700 dark:text-slate-300 bg-white dark:bg-slate-700 hover:bg-gray-50 dark:hover:bg-slate-600"
              @click="showViewPromptModal = false"
            >
              Close
            </button>
    ...
    <Teleport to="body">
      ...
      >
        <div class="bg-white dark:bg-slate-900 rounded-xl max-w-md w-full p-6" @click.stop>
          <h3 class="text-lg font-medium text-gray-900 dark:text-white">Delete Prompt</h3>
          <p class="mt-2 text-sm text-gray-500 dark:text-slate-400">
            Are you sure you want to delete the prompt "{{ promptToDelete?.name }}"? This action
            cannot be undone.
          </p>
    ...
    <Teleport to="body">
      ...
      >
        <div class="bg-white dark:bg-slate-900 rounded-lg max-w-4xl w-full p-6" @click.stop>
          <h3 class="text-lg font-medium text-gray-900 dark:text-white mb-4">Schema Templates</h3>
          ...
          <div class="grid grid-cols-2 gap-4">
            <button
              ...
              :key="template.name"
              class="p-4 border rounded-lg hover:border-indigo-500 hover:bg-indigo-50 dark:hover:bg-indigo-900/20 text-left transition-colors"
    ...
    <Teleport to="body">
      ...
      >
        <div class="bg-white dark:bg-slate-900 rounded-lg max-w-2xl w-full p-6" @click.stop>
    ...
    <Teleport to="body">
      ...
      >
        <div class="bg-white dark:bg-slate-900 rounded-lg max-w-md w-full p-6" @click.stop>
          <h3 class="text-lg font-medium text-gray-900 dark:text-white">Delete Schema</h3>
          <p class="mt-2 text-sm text-gray-500 dark:text-slate-400">
            Are you sure you want to delete the schema "{{ schemaToDelete?.schema_name }}"? This
...
const updatePrompt = async () => {
  ...
  try {
    const response = await api.put(
      `/project/${props.projectId}/prompt/${currentPrompt.value.id}`,
      promptForm.value,
    )
