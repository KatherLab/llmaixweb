                ...
                <div class="flex">
                  ...
                  <div>
                    <h3 class="text-sm font-medium text-red-800">
                      Field Errors for "{{ fieldName }}"
                    </h3>
                    <p class="mt-1 text-sm text-red-700">
                      {{ fieldErrors.length }} error(s) found for this field across different
                      documents.
                    </p>
                  </div>
                </div>
                  ...
                  <div class="flex justify-between items-start mb-3">
                    <div>
                      <h4 class="text-sm font-medium text-red-800">
                        Document #{{ fieldError.document_id }}
                      </h4>
                      <p class="text-xs text-red-600 mt-1">
                        {{ fieldError.document_name || 'Unknown file' }}
                      </p>
                    </div>
                    <div class="text-xs text-gray-500">Error Type: {{ fieldError.error_type }}</div>
                  </div>
                  ...
                  <div class="mt-3 bg-white border border-gray-200 rounded p-3">
                    ...
                    <div class="text-xs text-gray-600 space-y-1">
                      <div>
                        ...
                        {{ getErrorTypeDescription(fieldError.error_type) }}
                      </div>
                      <div v-if="fieldError.confidence_score !== null">
                        <strong>Confidence:</strong>
                        {{ (fieldError.confidence_score * 100).toFixed(1) }}%
                      </div>
                      <div>
                        <strong>Suggestion:</strong> {{ getErrorSuggestion(fieldError.error_type) }}
                      </div>
                    </div>
