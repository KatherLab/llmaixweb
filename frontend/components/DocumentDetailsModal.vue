<template>
  <Teleport to="body">
    <transition name="fade">
      ...
      >
        <div
          class="bg-white rounded-2xl shadow-2xl w-full max-w-5xl max-h-[95vh] flex flex-col border border-gray-200"
          @click.stop
        >
          <div
          ...
          >
            <h3 class="text-lg font-semibold text-gray-900">
              Document #{{ document.document_id }} Details
            </h3>
            <button
                ...
                <div class="flex justify-between items-start mb-4">
                  <div>
                    <h2 class="text-xl font-semibold text-gray-800">
                      Document #{{ documentDetail.document_id }}
                    </h2>
                    <p class="text-gray-600">
                      {{ documentDetail.document_name || 'Unknown filename' }}
                    </p>
                  </div>
                    ...
                    <div class="grid grid-cols-2 gap-4">
                      <div class="bg-white border rounded p-3">
                        ...
                        <p class="text-sm text-gray-800">
                          {{ fieldDetail.ground_truth_value || 'No value' }}
                        </p>
                      </div>
                      <div class="bg-white border rounded p-3">
                        <h5 class="text-xs font-medium text-gray-700 mb-1">Predicted</h5>
                        <p class="text-sm text-gray-800">
                          {{ fieldDetail.predicted_value || 'No value' }}
                        </p>
                      </div>
                    </div>
                      ...
                      <div class="w-full bg-gray-200 rounded-full h-2">
                        <div
                          ...
                          :class="{
                            ...
                            'bg-yellow-500':
                              fieldDetail.confidence_score >= 0.5 &&
                              fieldDetail.confidence_score < 0.8,
