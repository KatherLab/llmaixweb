  ...
  <teleport to="body">
    <transition name="fade">
      ...
      >
        ...
        >
          <div
            class="px-8 py-6 border-b bg-gray-50 rounded-t-2xl flex justify-between items-center"
          >
              ...
              <div>
                ...
                <div class="mb-8 bg-white border rounded-xl p-6 shadow">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      :disabled="
                        isLoadingModels || isTestingConnection || availableModels.length === 0
                      "
                ...
                <div>
                  ...
                  <div
                    ...
                    class="mt-2 bg-gray-50 border rounded-lg p-4 grid gap-6"
                  >
                    <div>
                      ...
                      <p class="mt-1 text-xs text-gray-500">
                        Limit the maximum tokens for model responses. Leave empty to use model
                        defaults.
                      </p>
                    </div>
                    <div>
                      ...
                      />
                      <p class="mt-1 text-xs text-gray-500">
                        Controls randomness. Lower values make outputs more focused; higher values
                        make them more random. Typical: 0.0–1.0
                      </p>
                    </div>
                    <div>
                      <label class="block text-sm font-medium text-gray-700 mb-1">
                      ...
                      <p class="mt-1 text-xs text-gray-500">
                        Hints the model how much compute to spend on chain-of-thought/reasoning. Not
                        all models/APIs support this.
                      </p>
                    </div>
                  </div>
                  ...
                  >
                    <div class="flex items-center justify-between">
                      <div class="flex items-center gap-2">
                        <svg
                          v-if="modelTestStatus.type === 'loading'"
                        ...
                        <svg
                          v-else-if="modelTestStatus.type === 'warning'"
                        ...
                        <svg
                          v-else-if="modelTestStatus.type === 'error'"
                        ...
                        <svg
                          v-else-if="modelTestStatus.type === 'success'"
                    ...
                    <div
                      v-if="modelTestStatus.type === 'warning'"
                      class="mt-3 p-3 bg-yellow-100 border border-yellow-200 rounded-md"
                    >
                      <p class="text-yellow-800 text-sm">
                        <strong>Required:</strong> You must test the selected model with the schema
                        to ensure compatibility before creating a trial.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div class="bg-white border rounded-xl p-6 shadow flex flex-col h-full">
                  ...
                  >
                    ...
                    <span class="text-xs text-gray-500"
                      >{{ trialData.document_ids.length }} selected</span
                    >
                  </div>
                  ...
                  <div
                    v-if="documentSelectionMode === 'individual'"
                  ...
                  >
                    ...
                    <div
                      class="border rounded-md overflow-hidden flex-1 min-h-[100px] flex flex-col"
                    >
                  ...
                  <!-- GROUPS -->
                  <div
                    v-else-if="documentSelectionMode === 'groups'"
                    class="mt-4 flex-1 flex flex-col"
                  >
                    ...
                    <div
                      v-else-if="documentGroups.length === 0"
                      ...
                      >
                        <div class="flex items-center justify-between">
                          <div class="flex-1">
                            ...
                            <div
                              v-if="group.tags && group.tags.length > 0"
                  ...
                  <!-- SMART -->
                  <div
                    v-else-if="documentSelectionMode === 'smart'"
                    class="mt-4 flex-1 flex flex-col gap-4"
                  >
                    <div>
                    ...
                    <div
                      v-if="trialData.document_ids.length > 0"
...
const selectAllDocuments = async () => {
  ...
  try {
    ...
    trialData.value.document_ids = Array.from(new Set([...trialData.value.document_ids, ...ids]))
