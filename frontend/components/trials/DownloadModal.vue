...
<template>
  <Teleport to="body">
    <transition name="fade">
      ...
      >
        <div
          class="bg-white rounded-2xl shadow-2xl max-w-md w-full p-6 flex flex-col max-h-[80vh] overflow-auto border border-gray-200"
        >
          ...
          >
            ...
            <span v-if="isJsonZip">
              <strong>JSON (per-document):</strong> Downloads a <b>ZIP archive</b> with one JSON
              file per document.
              <span class="block">
            ...
            <span v-else-if="isCsvZip">
              <strong>CSV (with files):</strong> Downloads a <b>ZIP archive</b> with the CSV and
              attached files.
              <span class="block">
            ...
            <span v-else>
              ...
              Includes all extracted results, document metadata, preprocessing configuration, and
              trial configuration.
            </span>
          </div>
