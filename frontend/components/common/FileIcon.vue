<template>
  <div :style="{ width: `${size}px`, height: `${size}px` }">
    ...
    >
      <path
        d="M7 2H17L22 7V20C22 21.1 21.1 22 20 22H4C2.9 22 2 21.1 2 20V4C2 2.9 2.9 2 4 2H7Z"
        fill="#E53E3E"
      />
      <path d="M17 2V7H22" fill="#C53030" />
      <text x="50%" y="70%" text-anchor="middle" fill="white" font-size="8" font-weight="bold">
        PDF
      </text>
    </svg>
