    ...
    <div class="fixed inset-0 z-50 overflow-hidden">
      ...
      <div class="absolute inset-4 md:inset-8 bg-white rounded-lg shadow-2xl flex flex-col max-w-4xl mx-auto">
        ...
        <div class="flex-1 overflow-y-auto">
          <!-- Summary Stats -->
          <div class="p-6 bg-gray-50 grid grid-cols-1 md:grid-cols-4 gap-4">
                  ...
                  <div class="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <p class="text-xs text-gray-500">
                        {{ fileTask.processing_time ? `Processed in ${fileTask.processing_time}s` : 'Pending' }}
                      </p>
                    </div>
                  </div>
        ...
        <div class="p-6 border-t bg-gray-50">
          <div class="flex justify-between items-center">
            <div v-if="task.failed_files > 0" class="text-sm text-gray-600">
              {{ task.failed_files }} file{{ task.failed_files !== 1 ? 's' : '' }} failed to process
            </div>
            <div v-else></div>
...
// Mock file tasks for demonstration
const fileTasks = ref([
  // This would come from the task.file_tasks property
  ...
  { id: 3, file_name: 'document3.pdf', status: 'completed', processing_time: 3.2 },
]);
