<template>
  ...
  >
    <div class="p-4">
        ...
        <div class="flex items-center space-x-3">
          <div class="flex-shrink-0">
            ...
            >
              <svg
                class="h-5 w-5"
                :class="hasWarnings ? 'text-amber-600' : 'text-green-600'"
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
          ...
          <div>
            ...
            <p class="text-sm text-gray-500">
              ...
              <span v-if="task.started_at"
                >• Started {{ formatRelativeTime(task.started_at) }}</span
              >
            </p>
          </div>
        </div>
      ...
      <div
        v-if="isActive && task.meta && typeof task.meta.eta_seconds === 'number'"
      ...
      <div
        ...
        class="flex flex-wrap gap-4 items-center text-sm mt-2 mb-1"
      >
        ...
        <span v-if="task.completed_at" class="text-gray-500 ml-auto">
