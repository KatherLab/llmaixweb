      ...
      <div class="bg-white rounded-2xl shadow-2xl max-w-md w-full" @click.stop>
        <div class="px-6 py-5">
          ...
          <p class="text-sm text-gray-500 mb-4">
            Use this link to invite a user. The email will be automatically pre-filled when they
            open the link.
          </p>
          ...
          <div class="flex items-center mt-2">
            ...
            >
              <span
                v-if="copySuccess"
                class="absolute bg-gray-800 text-white text-xs px-2 py-1 rounded -mt-10 ml-1"
              >
                Copied!
              </span>
              <svg
  ...
  },
  {
    ...
    cellRenderer: (params) => {
      ...
      if (!params.data.is_used) {
        ...
        showLinkBtn.className =
          'px-3 py-1.5 text-xs font-medium rounded text-white bg-blue-500 hover:bg-blue-600'
        ...
        deleteBtn.className =
          'px-3 py-1.5 text-xs font-medium rounded text-white bg-red-500 hover:bg-red-600'
