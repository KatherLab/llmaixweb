<template>
  <div class="w-full max-w-md">
    ...
    <div v-if="state === 'loading'" class="bg-white border border-gray-200 rounded-xl p-8 shadow-sm text-center">
    ...
    <div v-else-if="state === 'invalid'" class="bg-white border border-gray-200 rounded-xl p-8 shadow-sm text-center">
      ...
      <p class="text-sm text-gray-500 mb-6">
        This password reset link is no longer valid. It may have expired (links are valid for 24 hours) or already been used.
      </p>
      <router-link
        to="/forgot-password"
