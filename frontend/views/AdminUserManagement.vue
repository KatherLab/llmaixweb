  ...
  <div class="min-h-screen bg-gradient-to-br from-gray-100 via-white to-blue-100">
    ...
    <main class="max-w-7xl mx-auto py-8 px-6 space-y-12">
      <section class="card">
        <div class="flex justify-between items-center mb-4">
          <h2 class="text-lg font-semibold text-gray-900">
            Users
            <span
              class="ml-2 text-xs bg-blue-50 text-blue-700 px-2 py-0.5 rounded-full border border-blue-100"
      ...
      <transition name="fade">
        ...
        >
          <div
            class="bg-white/90 rounded-2xl shadow-2xl w-full max-w-md"
          ...
          >
            <div class="px-8 py-7">
              ...
              <form @submit.prevent="sendInvitation">
                <div class="mb-5">
                  <label for="email" class="block text-xs font-bold text-gray-600 mb-1"
                    >Email address</label
                  >
                  <input
                    id="email"
                ...
                <div v-if="inviteSuccess" class="mb-4">
                  ...
                  >
                    ...
                    <template v-else>
                      Invitation created but email delivery is not configured. Copy the link
                      manually.
                    </template>
                  </div>
                  <div class="flex items-center mt-2 gap-2">
                    ...
                    >
                      <span
                        v-if="copySuccess"
                        class="absolute bg-gray-800 text-white text-xs px-2 py-1 rounded -top-8 left-1/2 -translate-x-1/2 z-10"
                      >
                        Copied!
                      </span>
        ...
        >
          ...
          >
            ...
            <div class="px-8 py-6 space-y-6">
              <!-- Error / Success -->
              <div v-if="editError" class="p-3 bg-red-50 text-red-700 text-xs rounded-md">
                {{ editError }}
              </div>
              <div v-if="editSuccess" class="p-3 bg-green-50 text-green-700 text-xs rounded-md">
                User updated successfully!
              </div>
              <div
                v-if="setPasswordSuccessMsg"
                class="p-3 bg-green-50 text-green-700 text-xs rounded-md"
              >
                ...
                <div class="space-y-4">
                  ...
                  <div class="flex gap-4">
                    <div class="flex-1">
                      ...
                      <p v-if="editUser.id === currentUserId" class="text-xs text-amber-600 mt-1">
                    ...
                    <div class="flex-1">
                      ...
                      <div class="flex items-center gap-3 mt-2">
                        ...
                        <span
                          class="text-sm"
                          :class="editForm.is_active ? 'text-green-700' : 'text-red-600'"
                        >
      ...
      <transition name="fade">
        <div
          ...
          class="fixed inset-0 z-[60] bg-black/30 backdrop-blur-md flex items-center justify-center p-4"
          @click="cancelDelete"
        >
                ...
                >
                  ...
                  <div>
                    ...
                    <ul class="mt-2 text-sm text-red-700 list-disc list-inside space-y-1">
                      ...
                      <li>
                        <strong>All projects</strong> owned by this user, including files,
                        documents, schemas, prompts, trials, and evaluations
                      </li>
