 ...
 * @returns {number}
 */
export function getEvaluationAccuracy(evaluation) {
 ...
 * @returns {string}
 */
export function getEvaluationAccuracyPct(evaluation, digits = 1) {
 ...
 * @returns {number}
 */
export function getEvaluationDocumentCount(evaluation) {
  if (!evaluation) return 0
 ...
 * @returns {object[]}
 */
export function getEvaluationDocuments(evaluation) {
  if (!evaluation) return []
  return evaluation.document_summaries || evaluation.document_metrics || []
}
 ...
 * @returns {string}
 */
export function prettifyField(key) {
  if (!key) return ''
  const last =
    String(key)
      .split(/[.[\]]/)
 ...
 * @returns {string}
 */
export function documentStatusLabel(doc) {
  if (!doc) return ''
 ...
 */
export function documentStatusColor(doc) {
 ...
 * @returns {string}
 */
export function prettifyErrorType(errorType) {
  if (!errorType) return ''
