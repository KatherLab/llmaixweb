...
def test_document_cascade_delete(client, api_url):
    ...
    pid = client.post(
        f"{api_url}/project", headers=headers, json={"name": "CascadeProj"}
    ).json()["id"]
    prompt_id = client.post(
        f"{api_url}/project/{pid}/prompt",
        headers=headers,
...
def test_file_cascade_delete(client, api_url):
    ...
    pid = client.post(
        f"{api_url}/project", headers=headers, json={"name": "FileCascadeProj"}
    ).json()["id"]
    prompt_id = client.post(
        f"{api_url}/project/{pid}/prompt",
        headers=headers,
